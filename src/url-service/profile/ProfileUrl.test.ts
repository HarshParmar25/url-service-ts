...
describe("Profile data from url", () => {
  test("get state from Url", () => {
    const data = LocationProfile.getProfileDataFromUrlWithState(
      `https://revo.uatz.view.com.au/profile/for-vic/?page=2`
    );
    const result = { state: "vic", queryParams: { page: "2" } };
  ...
  test("get state suburb and postalcode", () => {
    const data = LocationProfile.getProfileDataFromUrlWithSuburb(
      `https://revo.uatz.view.com.au/profile/for-vic/melbourne-3000/?page=2`
    );
    const result = {
      state: "vic",
      suburb: "Melbourne",
...
describe("Url From Data Location Profile", () => {
  test(`get state Url`, () => {
    const data = LocationProfile.getUrlFromProfileDataWithState({ state: "vic", queryParams: { page: "2" } });
    const result = `/profile/for-vic/?page=2`;
  ...
  test(`get city Url`, () => {
    const data = LocationProfile.getUrlFromProfileDataWithCity({
      state: "vic",
      city: "MelBo/urne",
      cityId: 3000,
      queryParams: { page: "2", limit: "3" },
    });
    const result = `/profile/for-vic/melbo-urne-city-3000/?page=2&limit=3`;
  ...
  test(`get region Url`, () => {
    ...
    const result = `/profile/for-vic/melbourne-region-3000/?page=2&limit=3`;
...
describe("unhandled urls", () => {
  ...
  test("shoud return false", () => {
    const data = LocationProfile.getProfileDataFromUrl(`/agent-profile/mark-imbesi-98524/?page=2`);
    expect(data).toEqual(false);
  });
